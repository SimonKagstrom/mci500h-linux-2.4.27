...
#define SD_SEND_RELATIVE_ADDR    3   /* bcc           R6 */
...
#define SD_APP_SET_BUS_WIDTH      (6 +56)  /* ac   [1:0] bus width    R1  */
#define SD_SD_STATUS             (13 +56)  /* adtc                    R1  */
#define SD_SEND_NUM_WR_BLOCKS    (22 +56)  /* adtc                     R1  */
#define SD_SETWR_BLK_ERASE_COUNT (23 +56)  /* ac   [22:0] Number of blocks R1*/
#define SD_APP_OP_COND           (41 +56)  /* bcr  [31:0] OCR         R3  */
#define SD_APP_SEND_SCR          (51 +56)  /* adtc                    R1  */

#define BUS_WIDTH_4_bits 0x2
