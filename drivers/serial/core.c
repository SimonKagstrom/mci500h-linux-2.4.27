...
extern void ssauart_console_init(void);
extern void pnx010x_uart_console_init(void);
extern void spi_uart_console_init(void);
extern void null_uart_console_init(void);
