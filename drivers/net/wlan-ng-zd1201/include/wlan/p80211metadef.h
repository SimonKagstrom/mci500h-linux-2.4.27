...
#define DIDmsg_p2req_channel_info_results_pcfactive \
			...
			P80211DID_MKGROUP(18) | \
			P80211DID_MKITEM(6) | 0x00000000)
#define DIDmsg_p2req_zd1201_state \
			(P80211DID_MKSECTION(5) | \
			P80211DID_MKGROUP(19))
#define DIDmsg_p2req_zd1201_state_enable \
			(P80211DID_MKSECTION(5) | \
			P80211DID_MKGROUP(19) | \
			P80211DID_MKITEM(1) | 0x00000000)
#define DIDmsg_p2req_zd1201_state_resultcode \
			(P80211DID_MKSECTION(5) | \
			P80211DID_MKGROUP(19) | \
			P80211DID_MKITEM(2) | 0x00000000)
#define DIDmsg_p2req_zd1201_fwwrite \
			(P80211DID_MKSECTION(5) | \
			P80211DID_MKGROUP(20))
#define DIDmsg_p2req_zd1201_fwwrite_addr \
			(P80211DID_MKSECTION(5) | \
			P80211DID_MKGROUP(20) | \
			P80211DID_MKITEM(1) | 0x00000000)
#define DIDmsg_p2req_zd1201_fwwrite_len \
			(P80211DID_MKSECTION(5) | \
			P80211DID_MKGROUP(20) | \
			P80211DID_MKITEM(2) | 0x00000000)
#define DIDmsg_p2req_zd1201_fwwrite_data \
			(P80211DID_MKSECTION(5) | \
			P80211DID_MKGROUP(20) | \
			P80211DID_MKITEM(3) | 0x00000000)
#define DIDmsg_p2req_zd1201_fwwrite_resultcode \
			(P80211DID_MKSECTION(5) | \
			P80211DID_MKGROUP(20) | \
			P80211DID_MKITEM(4) | 0x00000000)
#define DIDmsg_p2req_enable \
			(P80211DID_MKSECTION(5) | \
			P80211DID_MKGROUP(21))
