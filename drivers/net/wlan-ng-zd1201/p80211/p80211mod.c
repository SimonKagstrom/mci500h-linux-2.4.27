...
/*
   EXPORT_SYMTAB is defined on the command line for p80211mod.c by the original
   wlan-ng makefile setup. For easy in-kernel-tree building, add it here instead.
*/ 
...
MODULE_PARM (wlan_watchdog, "i");
MODULE_PARM_DESC(wlan_watchdog, "transmit timeout in milliseconds");

#ifdef WLAN_INCLUDE_DEBUG
int wlan_debug=5;
MODULE_PARM(wlan_debug, "i"); 
